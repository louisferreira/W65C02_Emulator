...
namespace OpCodeViewer
{
    class Program
    {
        ...
        private static void CreateData()
        {
            ...
            { new Record{Mnemonic = "BBR0", OperationSummary = "Branch on bit 0 reset", FlagsAffected = "", OpCode = "0F", AddressCode = "r", Length = 3} },
            { new Record{Mnemonic = "BBR1", OperationSummary = "Branch on bit 1 reset", FlagsAffected = "", OpCode = "1F", AddressCode = "r", Length = 3} },
            { new Record{Mnemonic = "BBR2", OperationSummary = "Branch on bit 2 reset", FlagsAffected = "", OpCode = "2F", AddressCode = "r", Length = 3} },
            { new Record{Mnemonic = "BBR3", OperationSummary = "Branch on bit 3 reset", FlagsAffected = "", OpCode = "3F", AddressCode = "r", Length = 3} },
            { new Record{Mnemonic = "BBR4", OperationSummary = "Branch on bit 4 reset", FlagsAffected = "", OpCode = "4F", AddressCode = "r", Length = 3} },
            { new Record{Mnemonic = "BBR5", OperationSummary = "Branch on bit 5 reset", FlagsAffected = "", OpCode = "5F", AddressCode = "r", Length = 3} },
            { new Record{Mnemonic = "BBR6", OperationSummary = "Branch on bit 6 reset", FlagsAffected = "", OpCode = "6F", AddressCode = "r", Length = 3} },
            { new Record{Mnemonic = "BBR7", OperationSummary = "Branch on bit 7 reset", FlagsAffected = "", OpCode = "7F", AddressCode = "r", Length = 3} },
            { new Record{Mnemonic = "BBS0", OperationSummary = "Branch on bit 0 set", FlagsAffected = "", OpCode = "8F", AddressCode = "r", Length = 3} },
            { new Record{Mnemonic = "BBS1", OperationSummary = "Branch on bit 1 set", FlagsAffected = "", OpCode = "9F", AddressCode = "r", Length = 3} },
            { new Record{Mnemonic = "BBS2", OperationSummary = "Branch on bit 2 set", FlagsAffected = "", OpCode = "AF", AddressCode = "r", Length = 3} },
            { new Record{Mnemonic = "BBS3", OperationSummary = "Branch on bit 3 set", FlagsAffected = "", OpCode = "BF", AddressCode = "r", Length = 3} },
            { new Record{Mnemonic = "BBS4", OperationSummary = "Branch on bit 4 set", FlagsAffected = "", OpCode = "CF", AddressCode = "r", Length = 3} },
            { new Record{Mnemonic = "BBS5", OperationSummary = "Branch on bit 5 set", FlagsAffected = "", OpCode = "DF", AddressCode = "r", Length = 3} },
            { new Record{Mnemonic = "BBS6", OperationSummary = "Branch on bit 6 set", FlagsAffected = "", OpCode = "EF", AddressCode = "r", Length = 3} },
            { new Record{Mnemonic = "BBS7", OperationSummary = "Branch on bit 7 set", FlagsAffected = "", OpCode = "FF", AddressCode = "r", Length = 3} },
